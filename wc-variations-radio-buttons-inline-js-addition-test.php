 ...
 if ( is_plugin_active( 'woocommerce/woocommerce.php' ) ) {
	 ...
	 class WC_Radio_Buttons {
		 ...
		 function load_scripts() {
		 		wp_enqueue_style( 'radio-variations', $this->get_plugin_url() . 'assets/radio-variations.css', '', '' );
				wp_add_inline_script( 'wc-add-to-cart-variation', 'jQuery(function($){
  function sync($radio){
  ...
  $("form.variations_form input[type=radio][name^=attribute_]:checked").each(function(){
    sync($(this));
				...
				function footer_svg(){ ?>
					...
					add_action('wp_footer', 'footer_svg');
				 }
